...
(1, 'Donald Byrne', 'Robert James Fischer', 'Third Rosenwald Trophy', 'New York, NY USA', '1956.10.17', '8', '0-1', NULL, NULL, 'D92', 'Grünfeld Defense', 'advanced', 'Known as ''The Game of the Century,'' 13-year-old Bobby Fischer defeats Donald Byrne with a stunning queen sacrifice. This brilliant tactical masterpiece showcases Fischer''s early genius and is considered one of the greatest chess games ever played.', '[Event "Third Rosenwald Trophy"]
...
37. Rxd3 Rc1 38. Nb2 Qf2 39. Nd2 Rxd1+ 40. Nxd1 Re1+ 0-1', 40, '["world-championship","kasparov","karpov","sicilian","legendary"]', 'Legendary Games'),

(3, 'Adolf Anderssen', 'Lionel Kieseritzky', 'London casual game', 'London ENG', '1851.06.21', '?', '1-0', NULL, NULL, 'C33', 'King''s Gambit Accepted: Bishop''s Gambit', 'intermediate', 'Dubbed ''The Immortal Game,'' Anderssen sacrifices both rooks, a bishop, and his queen to deliver a stunning checkmate with his three remaining minor pieces. Played during a break at the 1851 London tournament, it is widely regarded as the most brilliant attacking game in chess history.', '[Event "London casual game"]
[Site "London ENG"]
[Date "1851.06.21"]
[Round "?"]
...
23. Be7# 1-0', 23, '["king''s-gambit","sacrifice","legendary","attacking","19th-century"]', 'Legendary Games'),

(4, 'Paul Morphy', 'Duke of Brunswick & Count Isouard', 'Paris Opera', 'Paris FRA', '1858.11.02', '?', '1-0', NULL, NULL, 'C41', 'Philidor Defense', 'beginner', 'Known as ''The Opera Game,'' Morphy played this masterpiece during a performance at the Paris Opera, reportedly annoyed at being dragged away from the music. A textbook demonstration of rapid development and piece activity, culminating in a beautiful back-rank checkmate. It remains the definitive example of classical opening principles.', '[Event "Paris Opera"]
[Site "Paris FRA"]
[Date "1858.11.02"]
[Round "?"]
[White "Paul Morphy"]
...
16. Qb8+ Nxb8 17. Rd8# 1-0', 17, '["development","tactics","back-rank","legendary","19th-century"]', 'Legendary Games'),

(5, 'Garry Kasparov', 'Veselin Topalov', 'Hoogovens', 'Wijk aan Zee NED', '1999.01.20', '4', '1-0', 2812, 2700, 'B06', 'Modern Defense', 'advanced', 'Often called ''Kasparov''s Immortal,'' this game features one of the most spectacular king marches in chess history. Kasparov sacrifices a rook on move 24 and then chases the Black king across the board with relentless energy, delivering a final mating attack that left spectators and analysts in awe. Frequently voted the greatest game of the 20th century.', '[Event "Hoogovens"]
...
40. Qa8 c3 41. Qa4+ Ke1 42. f4 f5 43. Kc1 Rd2 44. Qa7 1-0', 44, '["king-hunt","sacrifice","legendary","kasparov","modern-defense"]', 'Legendary Games'),

(6, 'Deep Blue', 'Garry Kasparov', 'IBM Man-Machine, Game 2', 'New York, NY USA', '1997.05.04', '2', '1-0', NULL, 2795, 'C93', 'Ruy Lopez: Closed, Smyslov Defense', 'advanced', 'A landmark moment in chess and computing history: IBM''s supercomputer Deep Blue defeats world champion Garry Kasparov in a game from their historic 1997 rematch. Deep Blue demonstrates positional understanding and long-term planning once thought exclusive to humans, playing 36. axb5! and building a winning advantage that forced Kasparov''s resignation. This victory shocked the world and marked a turning point in artificial intelligence.', '[Event "IBM Man-Machine, Game 2"]
[Site "New York, NY USA"]
[Date "1997.05.04"]
[Round "2"]
[White "Deep Blue"]
...
43. Qc6 Qb6+ 44. Kf1 Rb8 45. Ra6 1-0', 45, '["computer-chess","ai","historic","ruy-lopez","kasparov"]', 'Legendary Games');
